...
function connect_db()
{
    ...
    if (!$conn){
        $conn = mysqli_connect('localhost', 'root', '', 'register') or die ('Can\'t not connect to database');
...
function get_all_students()
{
    ...
    $sql = "select * from thongtin_sinhvien";
...
function get_student($student_id)
{
    ...
    // Câu truy vấn lấy tất cả sinh viên
    $sql = "select * from thongtin_sinhvien where sv_id = {$student_id}";
...
function add_student($student_name, $student_sex, $student_birthday)
{
    ...
    // Câu truy vấn thêm
    $sql = "
            INSERT INTO thongtin_sinhvien(sv_name, sv_sex, sv_birthday) VALUES
